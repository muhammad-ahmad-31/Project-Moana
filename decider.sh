...
echo ""
echo -e $blue"New Configuration:"$transparent   "   It will create new configuration by searching for Target network. $red(Note: Run this at first time.)$transparent"
echo ""
